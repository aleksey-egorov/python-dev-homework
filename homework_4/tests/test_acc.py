...
class TestAccCommon(TestMethods, unittest.TestCase):
    ...
    def test_online_score_score50(self, request):
    ...
    def test_online_score_score35(self, request):
        response = self.get_http_response(request)
        self.assertEqual(api.OK, response.get("code"))
    ...
    def test_online_score_score30(self, request):
        response = self.get_http_response(request)
        self.assertEqual(api.OK, response.get("code"))
    ...
    def test_online_score_score20(self, request):
        response = self.get_http_response(request)
        self.assertEqual(api.OK, response.get("code"))
    ...
    def test_online_score_admin(self, request):
    ...
    def test_client_interests_1(self, request):
        response = self.get_http_response(request)
        self.assertEqual(api.OK, response.get("code"))
